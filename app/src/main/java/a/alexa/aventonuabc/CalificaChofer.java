...
public class CalificaChofer extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_califica_chofer);
    }

    public void calEnviada(View view){
        Intent intent = new Intent(CalificaChofer.this, PasajeroPrincipal.class);
